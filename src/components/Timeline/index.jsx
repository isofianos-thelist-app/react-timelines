...
class Timeline extends Component {
  ...
  render() {
    const { now, time, timebar, tracks, sticky, clickElement, nowRefreshInterval } = this.props
    ...
    return (
      <div className="rt-timeline" style={{ width: time.timelineWidthStyle }}>
        {now && <NowMarker now={now} visible time={time} nowRefreshInterval={nowRefreshInterval} />}
        {pointerDate && (
